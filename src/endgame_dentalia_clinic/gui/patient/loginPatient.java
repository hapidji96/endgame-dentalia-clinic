...
import endgame_dentalia_clinic.gui.*;
            ...
            if(!username.equals(userRs)){
               throw new NewInvalidUserException ("You have entered an invalid username");
                ...
                if(password.equals(password)){
                    new patientMenu(username).setVisible(true);
                    this.setVisible(false);
                            
                }else{
                    JOptionPane.showMessageDialog(null,"Error in login","Oh snap!", JOptionPane.WARNING_MESSAGE);
                }
